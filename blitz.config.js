...
const scriptSrc = "; script-src 'self' 'unsafe-inline' data polyfill.io *.tawk.to https://cdn.jsdelivr.net/emojione/2.2.7/lib/js/emojione.min.js *.googletagmanager.com *.google-analytics.com *.google.com *.gstatic.com *.stripe.com"
...
const cspString = "default-src 'self' fonts.gstatic.com *.tawk.to *.youtube.com *.youtu.be *.youtube-nocookie.com 'sha256-AJhf7SfDbCOGtG4Jt4Dyynp7aRDJsVMm0zBtXbYpHW8=' *.googletagmanager.com *.google-analytics.com *.google.com *.gstatic.com *.stripe.com" + styleSrc + scriptSrc + imgSrc + connectSrc + reportTo
